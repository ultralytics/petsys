...
[MATLAB](https://www.mathworks.com/products/matlab.html) >= 2018a with a common functiosn repository `$ git clone https://github.com/ultralytics/common-matlab` added to the MATLAB path `>> addpath(genpath('/common-matlab'))`, and the following toolbox installed:  
